      ...
      <div class="col-sm-6 d-flex justify-content-end align-items-center">
        <div class="btn-group me-2">
            <button type="button" class="btn btn-sort dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span>{{ $nifasMonthName }}</span>
            </button>
            <div class="dropdown-menu">
                <a class="dropdown-item" href="{{ request()->fullUrlWithQuery(['nifasMonth' => '']) }}">Semua</a>
                <a class="dropdown-item" href="{{ request()->fullUrlWithQuery(['nifasMonth' => '1']) }}">Januari</a>
                <a class="dropdown-item" href="{{ request()->fullUrlWithQuery(['nifasMonth' => '2']) }}">Februari</a>
                <a class="dropdown-item" href="{{ request()->fullUrlWithQuery(['nifasMonth' => '3']) }}">Maret</a>
                <a class="dropdown-item" href="{{ request()->fullUrlWithQuery(['nifasMonth' => '4']) }}">April</a>
                <a class="dropdown-item" href="{{ request()->fullUrlWithQuery(['nifasMonth' => '5']) }}">Mei</a>
                <a class="dropdown-item" href="{{ request()->fullUrlWithQuery(['nifasMonth' => '6']) }}">Juni</a>
                <a class="dropdown-item" href="{{ request()->fullUrlWithQuery(['nifasMonth' => '7']) }}">Juli</a>
                <a class="dropdown-item" href="{{ request()->fullUrlWithQuery(['nifasMonth' => '8']) }}">Agustus</a>
                <a class="dropdown-item" href="{{ request()->fullUrlWithQuery(['nifasMonth' => '9']) }}">September</a>
                <a class="dropdown-item" href="{{ request()->fullUrlWithQuery(['nifasMonth' => '10']) }}">Oktober</a>
                <a class="dropdown-item" href="{{ request()->fullUrlWithQuery(['nifasMonth' => '11']) }}">November</a>
                <a class="dropdown-item" href="{{ request()->fullUrlWithQuery(['nifasMonth' => '12']) }}">Desember</a>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-1 text-end">
                        ...
                        <div class="dropdown ml-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton{{ $record->id }}">
                                <a class="dropdown-item" href="{{ route('data-nifas.edit', [$record -> id, $record->id_ibu]) }}">Edit</a>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                <form id="deleteForm-{{ $record->id }}" action="{{ route('data-nifas.delete', $record->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
