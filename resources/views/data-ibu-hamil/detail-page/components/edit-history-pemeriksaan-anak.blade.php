        ...
        <div class="container">
            <div class="card card-custom">
                <div class="card-body">
                    ...
                    <!-- form section -->
                    <form action="{{ route('data-anak.history.update', $pemeriksaan->id) }}" method="POST">
                    @csrf
                    @method('PUT')

                        <input type="hidden" name="id_anak" value="{{ $pemeriksaan->id_anak }}">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group mt-5">
                                            ...
                                            <input type="date" name="tgl_pemeriksaan" id="tgl_pemeriksaan" class="form-control form-control-lg @error('tgl_pemeriksaan') is-invalid @enderror " value="{{ $pemeriksaan->tgl_pemeriksaan }}"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group mt-5">
                                            ...
                                            <input type="text" name="tinggi_badan" id="tinggi_badan" class="form-control form-control-lg @error('tinggi_badan') is-invalid @enderror" value="{{ $pemeriksaan->tinggi_badan }}"
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group mt-5">
                                            ...
                                            <input type="text" name="berat_badan" id="berat_badan" class="form-control form-control-lg @error('berat_badan') is-invalid @enderror" value="{{ $pemeriksaan->berat_badan }}"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group mt-5">
                                            ...
                                            <input type="text" name="catatan" id="catatan" class="form-control form-control-lg @error('catatan') is-invalid @enderror" value="{{ $pemeriksaan->catatan }}"
