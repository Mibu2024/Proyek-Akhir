        ...
        <div class="container">
            <div class="card card-custom">
                <div class="card-body">
                    ...
                    <!-- form section -->
                    <form action="{{ route('data-kehamilan.update', $data_kehamilans->id_kehamilan) }}" method="post">
                    @csrf
                    @method('PUT')
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group mt-5">
                                            ...
                                            <input type="date" name="tanggal_kehamilan" id="tanggal_kehamilan" class="form-control form-control-lg @error('tanggal_kehamilan') is-invalid @enderror" value="{{ $data_kehamilans->tanggal_kehamilan }}"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group mt-5">
                                            ...
                                            <input type="text" name="kehamilan_ke" id="kehamilan_ke" class="form-control form-control-lg @error('kehamilan_ke') is-invalid @enderror" value="{{ $data_kehamilans->kehamilan_ke }}"
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group mt-5">
                                            ...
                                            <input type="date" name="tanggal_hpl" id="tanggal_hpl" class="form-control form-control-lg @error('tanggal_hpl') is-invalid @enderror" value="{{ $data_kehamilans->tanggal_hpl}}"
                                                placeholder="Pilih Tanggal">
                                            @error('tanggal_hpl')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
