...
<div class="row mb-4">
    <div class="col-md-12 text-right d-flex justify-content-between align-items-center">
        <h2 class="mb-0">Data Ibu Hamil</h2>
        <div>
            <a href="{{ route('data-ibu-hamil.download') }}" class="btn btn-outline-primary ml-2">
                <i class="flaticon2-download"></i> Download
            </a>
            <a href="{{ route('data-ibu-hamil.create') }}" class="btn btn-primary ml-2">
    ...
    <div class="col-md-4">
        <form action="{{ route('home') }}" method="GET">
            <div class="input-group">
                <!-- Search Field -->
                <input type="text" name="search" value="{{ request('search') }}" class="form-control" placeholder="Cari ibu hamil" aria-label="Cari ibu hamil">
            </div>
        </form>
    </div>
