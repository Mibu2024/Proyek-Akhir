                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form action="{{ route('data-imunisasi.update', $data_imunisasis->id) }}" method="POST">
                                                ...
                                                <div class="form-group mt-5">
                                                    <label for="" class="form-label">Apakah Sudah Hepatitis B?</label>
                                                    <select class="form-control @error('hepatitis_b') is-invalid @enderror" id="hepatitis_b" name="hepatitis_b" title="Pilih Jawaban">
                                                        ...
                                                        <option value="Sudah" @if($data_imunisasis->hepatitis_b == 'Sudah') selected @endif>Sudah</option>
                                                        <option value="Belum" @if($data_imunisasis->hepatitis_b == 'Belum') selected @endif>Belum</option>
                                                    </select>
                                                    @error('hepatitis_b')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="form-group mt-5">
                                                    ...
                                                    <select class="form-control @error('bcg') is-invalid @enderror" id="bcg" name="bcg" title="Pilih Jawaban">
                                                        <option value="" disabled selected hidden>Pilih Jawaban</option>
                                                        <option value="Sudah" @if($data_imunisasis->bcg == 'Sudah') selected @endif>Sudah</option>
                                                        <option value="Belum" @if($data_imunisasis->bcg == 'Belum') selected @endif>Belum</option>
                                                    </select>
                                                    @error('bcg')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="form-group mt-5">
                                                    ...
                                                    <select class="form-control @error('polio_tetes_1') is-invalid @enderror" id="polio_tetes_1" name="polio_tetes_1" title="Pilih Jawaban">
                                                        <option value="" disabled selected hidden>Pilih Jawaban</option>
                                                        <option value="Sudah" @if($data_imunisasis->polio_tetes_1 == 'Sudah') selected @endif>Sudah</option>
                                                        <option value="Belum" @if($data_imunisasis->polio_tetes_1 == 'Belum') selected @endif>Belum</option>
                                                    </select>
                                                    @error('polio_tetes_1')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="form-group mt-5">
                                                    ...
                                                    <select class="form-control @error('dpt_hb_hib_1') is-invalid @enderror" id="dpt_hb_hib_1" name="dpt_hb_hib_1" title="Pilih Jawaban">
                                                        <option value="" disabled selected hidden>Pilih Jawaban</option>
                                                        <option value="Sudah" @if($data_imunisasis->dpt_hb_hib_1 == 'Sudah') selected @endif>Sudah</option>
                                                        <option value="Belum" @if($data_imunisasis->dpt_hb_hib_1 == 'Belum') selected @endif>Belum</option>
                                                    </select>
                                                    @error('dpt_hb_hib_1')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="form-group mt-5">
                                                    ...
                                                    <select class="form-control @error('polio_tetes_2') is-invalid @enderror" id="polio_tetes_2" name="polio_tetes_2" title="Pilih Jawaban">
                                                        <option value="" disabled selected hidden>Pilih Jawaban</option>
                                                        <option value="Sudah" @if($data_imunisasis->polio_tetes_2 == 'Sudah') selected @endif>Sudah</option>
                                                        <option value="Belum" @if($data_imunisasis->polio_tetes_2 == 'Belum') selected @endif>Belum</option>
                                                    </select>
                                                    @error('polio_tetes_2')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="form-group mt-5">
                                                    ...
                                                    <select class="form-control @error('rota_virus_1') is-invalid @enderror" id="rota_virus_1" name="rota_virus_1" title="Pilih Jawaban">
                                                        <option value="" disabled selected hidden>Pilih Jawaban</option>
                                                        <option value="Sudah" @if($data_imunisasis->rota_virus_1 == 'Sudah') selected @endif>Sudah</option>
                                                        <option value="Belum" @if($data_imunisasis->rota_virus_1 == 'Belum') selected @endif>Belum</option>
                                                    </select>
                                                    @error('rota_virus_1')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="form-group mt-5">
                                                    ...
                                                    <select class="form-control @error('pcv_1') is-invalid @enderror" id="pcv_1" name="pcv_1" title="Pilih Jawaban">
                                                        <option value="" disabled selected hidden>Pilih Jawaban</option>
                                                        <option value="Sudah" @if($data_imunisasis->pcv_1 == 'Sudah') selected @endif>Sudah</option>
                                                        <option value="Belum" @if($data_imunisasis->pcv_1 == 'Belum') selected @endif>Belum</option>
                                                    </select>
                                                    @error('pcv_1')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="form-group mt-5">
                                                    ...
                                                    <select class="form-control @error('dpt_hb_hib_2') is-invalid @enderror" id="dpt_hb_hib_2" name="dpt_hb_hib_2" title="Pilih Jawaban">
                                                        <option value="" disabled selected hidden>Pilih Jawaban</option>
                                                        <option value="Sudah" @if($data_imunisasis->dpt_hb_hib_2 == 'Sudah') selected @endif>Sudah</option>
                                                        <option value="Belum" @if($data_imunisasis->dpt_hb_hib_2 == 'Belum') selected @endif>Belum</option>
                                                    </select>
                                                    @error('dpt_hb_hib_2')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="form-group mt-5">
                                                    ...
                                                    <select class="form-control @error('polio_tetes_3') is-invalid @enderror" id="polio_tetes_3" name="polio_tetes_3" title="Pilih Jawaban">
                                                        <option value="" disabled selected hidden>Pilih Jawaban</option>
                                                        <option value="Sudah" @if($data_imunisasis->polio_tetes_3 == 'Sudah') selected @endif>Sudah</option>
                                                        <option value="Belum" @if($data_imunisasis->polio_tetes_3 == 'Belum') selected @endif>Belum</option>
                                                    </select>
                                                    @error('polio_tetes_3')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="form-group mt-5">
                                                    ...
                                                    <select class="form-control @error('rota_virus_2') is-invalid @enderror" id="rota_virus_2" name="rota_virus_2" title="Pilih Jawaban">
                                                        <option value="" disabled selected hidden>Pilih Jawaban</option>
                                                        <option value="Sudah" @if($data_imunisasis->rota_virus_2 == 'Sudah') selected @endif>Sudah</option>
                                                        <option value="Belum" @if($data_imunisasis->rota_virus_2 == 'Belum') selected @endif>Belum</option>
                                                    </select>
                                                    @error('rota_virus_2')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="form-group mt-5">
                                                    ...
                                                    <select class="form-control @error('pcv_2') is-invalid @enderror" id="pcv_2" name="pcv_2" title="Pilih Jawaban">
                                                        <option value="" disabled selected hidden>Pilih Jawaban</option>
                                                        <option value="Sudah" @if($data_imunisasis->pcv_2 == 'Sudah') selected @endif>Sudah</option>
                                                        <option value="Belum" @if($data_imunisasis->pcv_2 == 'Belum') selected @endif>Belum</option>
                                                    </select>
                                                    @error('pcv_2')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="form-group mt-5">
                                                    ...
                                                    <select class="form-control @error('dpt_hb_hib_3') is-invalid @enderror" id="dpt_hb_hib_3" name="dpt_hb_hib_3" title="Pilih Jawaban">
                                                        <option value="" disabled selected hidden>Pilih Jawaban</option>
                                                        <option value="Sudah" @if($data_imunisasis->dpt_hb_hib_3 == 'Sudah') selected @endif>Sudah</option>
                                                        <option value="Belum" @if($data_imunisasis->dpt_hb_hib_3 == 'Belum') selected @endif>Belum</option>
                                                    </select>
                                                    @error('dpt_hb_hib_3')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="form-group mt-5">
                                                    ...
                                                    <select class="form-control @error('polio_tetes_4') is-invalid @enderror" id="polio_tetes_4" name="polio_tetes_4" title="Pilih Jawaban">
                                                        <option value="" disabled selected hidden>Pilih Jawaban</option>
                                                        <option value="Sudah" @if($data_imunisasis->polio_tetes_4 == 'Sudah') selected @endif>Sudah</option>
                                                        <option value="Belum" @if($data_imunisasis->polio_tetes_4 == 'Belum') selected @endif>Belum</option>
                                                    </select>
                                                    @error('polio_tetes_4')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="form-group mt-5">
                                                    ...
                                                    <select class="form-control @error('polio_suntik_1') is-invalid @enderror" id="polio_suntik_1" name="polio_suntik_1" title="Pilih Jawaban">
                                                        <option value="" disabled selected hidden>Pilih Jawaban</option>
                                                        <option value="Sudah" @if($data_imunisasis->polio_suntik_1 == 'Sudah') selected @endif>Sudah</option>
                                                        <option value="Belum" @if($data_imunisasis->polio_suntik_1 == 'Belum') selected @endif>Belum</option>
                                                    </select>
                                                ...
                                                <div class="form-group mt-5">
                                                    ...
                                                    <select class="form-control @error('rota_virus_3') is-invalid @enderror" id="rota_virus_3" name="rota_virus_3" title="Pilih Jawaban">
                                                        <option value="" disabled selected hidden>Pilih Jawaban</option>
                                                        <option value="Sudah" @if($data_imunisasis->rota_virus_3 == 'Sudah') selected @endif>Sudah</option>
                                                        <option value="Belum" @if($data_imunisasis->rota_virus_3 == 'Belum') selected @endif>Belum</option>
                                                    </select>
                                                    @error('rota_virus_3')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="form-group mt-5">
                                                    ...
                                                    <select class="form-control @error('campak_rubella') is-invalid @enderror" id="campak_rubella" name="campak_rubella" title="Pilih Jawaban">
                                                        <option value="" disabled selected hidden>Pilih Jawaban</option>
                                                        <option value="Sudah" @if($data_imunisasis->campak_rubella == 'Sudah') selected @endif>Sudah</option>
                                                        <option value="Belum" @if($data_imunisasis->campak_rubella == 'Belum') selected @endif>Belum</option>
                                                    </select>
                                                ...
                                                <div class="form-group mt-5">
                                                    ...
                                                    <select class="form-control @error('polio_suntik_2') is-invalid @enderror" id="polio_suntik_2" name="polio_suntik_2" title="Pilih Jawaban">
                                                        <option value="" disabled selected hidden>Pilih Jawaban</option>
                                                        <option value="Sudah" @if($data_imunisasis->polio_suntik_2 == 'Sudah') selected @endif>Sudah</option>
                                                        <option value="Belum" @if($data_imunisasis->polio_suntik_2 == 'Belum') selected @endif>Belum</option>
                                                    </select>
                                                ...
                                                <div class="form-group mt-5">
                                                    ...
                                                    <select class="form-control @error('japanese_encephalitis') is-invalid @enderror" id="japanese_encephalitis" name="japanese_encephalitis" title="Pilih Jawaban">
                                                        <option value="" disabled selected hidden>Pilih Jawaban</option>
                                                        <option value="Sudah" @if($data_imunisasis->japanese_encephalitis == 'Sudah') selected @endif>Sudah</option>
                                                        <option value="Belum" @if($data_imunisasis->japanese_encephalitis == 'Belum') selected @endif>Belum</option>
                                                    </select>
                                                ...
                                                <div class="form-group mt-5">
                                                    ...
                                                    <select class="form-control @error('pcv_3') is-invalid @enderror" id="pcv_3" name="pcv_3" title="Pilih Jawaban">
                                                        <option value="" disabled selected hidden>Pilih Jawaban</option>
                                                        <option value="Sudah" @if($data_imunisasis->pcv_3 == 'Sudah') selected @endif>Sudah</option>
                                                        <option value="Belum" @if($data_imunisasis->pcv_3 == 'Belum') selected @endif>Belum</option>
                                                    </select>
                                                    @error('pcv_3')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="form-group mt-5">
                                                    ...
                                                    <select class="form-control @error('dpt_hb_hib_lanjutan') is-invalid @enderror" id="dpt_hb_hib_lanjutan" name="dpt_hb_hib_lanjutan" title="Pilih Jawaban">
                                                        <option value="" disabled selected hidden>Pilih Jawaban</option>
                                                        <option value="Sudah" @if($data_imunisasis->dpt_hb_hib_lanjutan == 'Sudah') selected @endif>Sudah</option>
                                                        <option value="Belum" @if($data_imunisasis->dpt_hb_hib_lanjutan == 'Belum') selected @endif>Belum</option>
                                                    </select>
                                                ...
                                                <div class="form-group mt-5">
                                                    ...
                                                    <select class="form-control @error('campak_rubella_lanjutan') is-invalid @enderror" id="campak_rubella_lanjutan" name="campak_rubella_lanjutan" title="Pilih Jawaban">
                                                        <option value="" disabled selected hidden>Pilih Jawaban</option>
                                                        <option value="Sudah" @if($data_imunisasis->campak_rubella_lanjutan == 'Sudah') selected @endif>Sudah</option>
                                                        <option value="Belum" @if($data_imunisasis->campak_rubella_lanjutan == 'Belum') selected @endif>Belum</option>
                                                    </select>
