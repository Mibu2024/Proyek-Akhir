                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <ul
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            <a href="{{ route('data-kesehatan.index') }}" class="text-muted">Data Artikel</a>
                                        </li>
                                        <li class="breadcrumb-item text-muted">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form action="{{ route('data-artikel.store') }}" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group mt-5">
                                                    <label for="author"><strong>Isi author</strong></label>
                                                ...
                                                <div class="form-group mt-5">
                                                    <label for="image"><strong>Upload Foto artikel</strong></label>
