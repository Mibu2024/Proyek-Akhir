                                                ...
                                                <div class="form-group mt-5"> 
                                                    ...
                                                    <select name="nama_ibu" id="nama_ibu" class="form-control @error('nama_ibu') is-invalid @enderror">
                                                        @foreach ($data_ibu_hamils as $ibu) 
                                                            <option value="{{$ibu->nama_ibu}}" data-id="{{ $ibu->id }}" {{$ibu->nama_ibu == $data_nifas->nama_ibu ? 'selected' : ''}}>{{$ibu->nama_ibu}}</option> 
                                                        @endforeach 
                                                    </select>
                                                    <input type="hidden" name="id_ibu" id="id_ibu" value="{{ $data_nifas->id_ibu }}">
                                                    @error('nama_ibu')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
