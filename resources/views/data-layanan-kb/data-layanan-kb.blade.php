                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <ul
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            <a href="javascript:void(0)" class="text-muted">Data Layanan KB</a>
                                        </li>
                                    </ul>
                                    <!--end::Breadcrumb-->
                                </div>
                        ...
                        <div class="container">
                            <div class="card card-custom">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-4">
                                            <form action="{{ route('data-layanan-kb.index') }}" method="GET">
                                        ...
                                        <div class="col-5 text-right">
                                            <a href="{{ route('data-layanan-kb.create') }}" type="button"
                                                class="btn btn-success"><i class="flaticon2-add-1"></i><strong>Data
                                                    Baru</strong>
                                            </a>
                                            <a href="{{ route('data-layanan-kb.download') }}" type="button"
                                    ...
                                    <div class="row table-responsive">
                                        <table class="table text-center">
                                            ...
                                            <tbody>
                                                @php
                                                    $num =
                                                        ($data_layanan_kbs->currentPage() - 1) * $data_layanan_kbs->perPage() + 1;
                                                @endphp
                                                @forelse ($data_layanan_kbs as $dih)
                                                    <tr>
                                                        <td>{{ $num++ }}</td>
                                                        <td>{{ $dih->nama_ibu }}</td>
                                                        <td>{{ $dih->tanggal_praktik }}</td>
                                                        <td>{{ $dih->tekanan_darah }}</td>
                                                        <td>{{ $dih->berat_badan }}</td>
                                                        <td>{{ $dih->jenis_kb }}</td>
                                                        <td>{{ $dih->tanggal_kembali }}</td>
                                                        <td>{{ $dih->keluhan }}</td>
                                                        <td>
                                                            <!-- Action buttons -->
                                                            <a href="{{ route('data-layanan-kb.edit', $dih->id) }}"><i
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <form id="deleteForm-{{ $dih->id }}"
                                                                                action="{{ route('data-layanan-kb.delete', $dih->id) }}"
                                                                                method="POST">
                                                                                @csrf
                                                                                @method('DELETE')
                                                                                <button type="submit"
                                        ...
                                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                                            <div class="d-flex align-items-center py-3">
                                                ...
                                                <form method="GET" action="data-layanan-kb.index">
                                                        <select id="entries"
        ...
        <script>
            $(document).ready(function() {
                $(document).on('change', '#entries', function() {
                    window.location =
                        "{{ route('data-layanan-kb.index') }}?search={{ request('search') }}&per_page=" + $(this)
                        .val();
                });
            });
        </script>
