                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <ul
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            <a href="{{ route('data-artikel.index') }}" class="text-muted">Data Artikel</a>
                                        </li>
                                        <li class="breadcrumb-item text-muted">
                        ...
                        <!--end::Subheader-->
                            <!-- Main content -->
                                <div class="container-fluid">
                                    <div class="card">
                                        <div class="card-body">
                                            <a href="{{ route('data-artikel.index') }}">
                                                <i class="flaticon2-back icon-xm text-success"> Kembali</i>
                                            </a>
                                            <h3 class="text-dark font-weight-bold mt-5 "><b>Edit Data Artikel</b></h3>

                                            <form action="{{ route('data-artikel.update', $data_artikels->id) }}" method="POST">
                                                @csrf
                                                @method('PUT')
                                                ...
                                                <div class="text-right">
                                                    <a href="{{ route('data-artikel.index') }}" class="btn btn-outline-danger mr-2"
                                                        role="button">Batal</a>
