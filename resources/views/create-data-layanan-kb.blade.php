                                ...
                                <div class="container-fluid">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form action="{{ route('data-layanan-kb.store') }}" method="post" enctype="multipart/form-data">
                                                @csrf

                                                <div class="form-group mt-5">
                                                    <label for="tanggal"><strong>Tanggal Periksa</strong></label>
                                                    <input type="date" name="tanggal_praktik" id="tanggal_praktik" class="form-control @error('tanggal_praktik') is-invalid @enderror"
                                                ...
                                                <div class="text-right">
                                                    <a href="{{ route('data-layanan-kb.index') }}" class="btn btn-outline-danger mr-2"
                                                        role="button">Batal</a>
