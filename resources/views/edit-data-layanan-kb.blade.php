                        ...
                        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
                            <div
                                ...
                                <div class="d-flex align-items-center flex-wrap mr-2">
                                    <!--begin::Page Title-->
                                    <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Data Layanan KB</h5>
                                    <!--end::Page Title-->
                                </div>
                                <!--end::Info-->
                                <!--begin::Toolbar-->
                                <div class="d-flex align-items-center">
                                    ...
                                    <ul
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            <a href="{{ route('data-kesehatan.index') }}" class="text-muted">Data Layanan KB</a>
                                        </li>
                                        <li class="breadcrumb-item text-muted">
                        ...
                        <!--end::Subheader-->
                            <!-- Main content -->
                                <div class="container-fluid">
                                    <div class="card">
                                        <div class="card-body">
                                            <a href="{{ route('data-layanan-kb.index') }}">
                                                <i class="flaticon2-back icon-xm text-success"> Kembali</i>
                                            </a>
                                            <h3 class="text-dark font-weight-bold mt-5 "><b>Edit Data Layanan KB</b></h3>

                                            <form action="{{ route('data-layanan-kb.update', $data_layanan_kbs->id) }}" method="POST">
                                                @csrf
                                                @method('PUT')
                                                <div class="form-group mt-5">
                                                    <label for="tanggal"><strong>Tanggal Praktik</strong></label>
                                                    <input type="date" name="tanggal_praktik" id="tanggal_praktik" class="form-control  @error('tanggal_praktik') is-invalid @enderror" value="{{ $data_layanan_kbs->tanggal_praktik }}"
                                                ...
                                                <div class="form-group mt-5"> 
                                                    ...
                                                    <select name="nama_ibu" id="nama_ibu" class="form-control @error('nama_ibu') is-invalid @enderror">
                                                        @foreach ($data_ibu_hamils as $ibu) 
                                                            <option value="{{$ibu->nama_ibu}}" data-id="{{ $ibu->id }}" {{$ibu->nama_ibu == $data_layanan_kbs->nama_ibu ? 'selected' : ''}}>{{$ibu->nama_ibu}}</option> 
                                                        @endforeach 
                                                    </select>
                                                    <input type="hidden" name="id_ibu" id="id_ibu" value="{{ $data_layanan_kbs->id_ibu }}">
                                                    @error('nama_ibu')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                                ...
                                                <div class="form-group mt-5">
                                                    ...
                                                    <input type="text" name="tekanan_darah" id="tekanan_darah" class="form-control @error('tekanan_darah') is-invalid @enderror" value="{{ $data_layanan_kbs->tekanan_darah }}"
                                                ...
                                                <div class="form-group mt-5">
                                                    ...
                                                    <input type="text" name="berat_badan" id="berat_badan" class="form-control @error('berat_badan') is-invalid @enderror" value="{{ $data_layanan_kbs->berat_badan }}"
                                                ...
                                                <div class="form-group mt-5">
                                                    ...
                                                    <select name="jenis_kb" id="jenis_kb" class="form-control @error('jenis_kb') is-invalid @enderror">
                                                ...
                                                <div class="form-group mt-5">
                                                    ...
                                                    <input type="date" name="tanggal_kembali" id="tanggal_kembali" class="form-control @error('tanggal_kembali') is-invalid @enderror" value="{{ $data_layanan_kbs->tanggal_kembali }}"
