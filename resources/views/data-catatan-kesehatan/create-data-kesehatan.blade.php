                ...
                <div class="card-body">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Create Data Kesehatan</li>
                        </ol>
                    </nav>
                    <hr>
                    ...
                    <input type="hidden" name="id_kehamilan" value="{{ $kehamilan -> id_kehamilan }}">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group mt-4">
                                <label><strong>Keluhan yang Dialami</strong></label>
                            ...
                            <div class="form-group mt-4">
                                <label><strong>Lingkar Perut</strong></label>
                                <input type="text" name="lingkar_perut" id="lingkar_perut" class="form-control form-control-lg @error('lingkar_perut') is-invalid @enderror"
                            ...
                            <div class="form-group mt-4">
                                <label><strong>Lingkar Lengan Atas</strong></label>
                                <input type="text" name="lingkar_lengan_atas" id="lingkar_lengan_atas" class="form-control form-control-lg @error('lingkar_lengan_atas') is-invalid @enderror"
                            ...
                            <div class="form-group mt-4">
                                <label><strong>Tekanan Darah (<span class="text-success">mmHg</span>)</strong></label>
                            ...
                            <div class="form-group mt-4">
                                <label><strong>Berat Badan (<span class="text-success">Kg</span>)</strong></label>
                            ...
                            <div class="form-group mt-4">
                                <label><strong>Umur Kehamilan (<span class="text-success">Hari/Minggu/bulan</span>)</strong></label>
                                <input type="text" name="umur_kehamilan" id="umur_kehamilan" class="form-control form-control-lg @error('umur_kehamilan') is-invalid @enderror"
                        ...
                        <div class="col-sm-6">
                            <div class="form-group mt-4">
                                <label><strong>Tinggi Fundus (<span class="text-success">Cm</span>)</strong></label>
                                <input type="text" name="tinggi_fundus" id="tinggi_fundus" class="form-control form-control-lg @error('tinggi_fundus') is-invalid @enderror"
                            ...
                            <div class="form-group mt-4">
                                <label><strong>Letak Janin (<span class="text-success">Kep/Su/Li</span>)</strong></label>
                                <input type="text" name="letak_janin" id="letak_janin" class="form-control form-control-lg @error('letak_janin') is-invalid @enderror"
                            ...
                            <div class="form-group mt-4">
                                <label><strong>Denyut Jantung Janin (<span class="text-success">BPM</span>)</strong></label>
                                <input type="text" name="denyut_jantung_janin" id="denyut_jantung_janin" class="form-control form-control-lg @error('denyut_jantung_janin') is-invalid @enderror"
                            ...
                            <div class="form-group mt-4">
                                <label><strong>Hasil Pemeriksaan Lab</strong></label>
                                <input type="text" name="hasil_lab" id="hasil_lab" class="form-control form-control-lg @error('hasil_lab') is-invalid @enderror"
                            ...
                            <div class="form-group mt-4">
                                <label><strong>Tindakan yang Dilakukan</strong></label>
                                <input type="text" name="tindakan" id="tindakan" class="form-control form-control-lg @error('tindakan') is-invalid @enderror"
                            ...
                            <div class="form-group mt-4">
                                <label><strong>Apakah Kaki Bengkak?</strong></label>
                                <input type="text" name="kaki_bengkak" id="kaki_bengkak" class="form-control form-control-lg @error('kaki_bengkak') is-invalid @enderror"
                            ...
                            <div class="form-group mt-4">
                                <label><strong>Nasihat untuk Ibu Hamil</strong></label>
                                <input type="text" name="nasihat" id="nasihat" class="form-control form-control-lg @error('nasihat') is-invalid @enderror"
                            ...
                            <div class="form-group mt-4">
                                <label><strong>Nama Pemeriksa</strong></label>
                                <input type="text" name="nama_pemeriksa" id="nama_pemeriksa" class="form-control form-control-lg @error('nama_pemeriksa') is-invalid @enderror"
